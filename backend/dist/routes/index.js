 ...
 *                 error: {}
 */
router.post('/login', uploads.none(), (0, validation_1.validateRequestBody)(User_1.userAuthSchema), UserController_1.UserController.login);
/**
 * @swagger
 * /register:
 *   post:
 ...
 *
*/
router.post('/register', uploads.none(), (0, validation_1.validateRequestBody)(User_1.userCreateSchema), UserController_1.UserController.register);
/**
 * @swagger
 * /verify:
 *   get:
 ...
 *                 error: {}
 */
router.get('/verify', auth_1.authJWT, UserController_1.UserController.verify);
/**
 * @swagger
 * /logout:
 *   get:
 ...
 *                 error: {}
 */
router.get('/profile/:userId', (0, validation_1.validateRequestParams)(User_1.getProfileParams), ProfileController_1.ProfileController.getProfile);
/**
 * @swagger
 * /profile/{userId}:
 *   put:
 ...
 *                 error: {}
 */
router.put('/profile/:userId', auth_1.authJWT, ProfileController_1.upload.single('profile_photo'), (0, validation_1.validateRequestParams)(User_1.userUpdateParams), (0, validation_1.validateRequestBody)(User_1.userUpdateSchema), ProfileController_1.ProfileController.profilUpdate);
// connection routes
/**
 * @swagger
 * /connection:
 ...
 *                 error: {}
 */
router.get('/connection', (0, validation_1.validateQueryParams)(Connection_1.usersGetQuery), ConnectionController_1.ConnectionController.getUsers);
/**
 * @swagger
 * /connection/send:
 *   post:
 ...
 *                 error: {}
 */
router.post('/connection/send', auth_1.authJWT, uploads.none(), (0, validation_1.validateRequestBody)(Connection_1.connectionSendSchema), ConnectionController_1.ConnectionController.connectionSend);
/**
 * @swagger
 * /connection/requests:
 *   get:
 ...
 *                 error: {}
 */
router.get('/connection/requests', auth_1.authJWT, ConnectionController_1.ConnectionController.connectionRequests);
/**
 * @swagger
 * /connection/connect:
 *   post:
 ...
 *                 error: {}
 */
router.post('/connection/connect', auth_1.authJWT, uploads.none(), (0, validation_1.validateRequestBody)(Connection_1.connectionConnectSchema), ConnectionController_1.ConnectionController.connectionConnect);
/**
 * @swagger
 ...
 *                 error: {}
 */
router.get('/connection/list/:userId', (0, validation_1.validateRequestParams)(Connection_1.connectionListParams), ConnectionController_1.ConnectionController.connectionList);
/**
 * @swagger
 ...
 *                 error: {}
 */
router.delete('/connection/delete/:to', auth_1.authJWT, (0, validation_1.validateRequestParams)(Connection_1.connectionDeleteParams), ConnectionController_1.ConnectionController.connectionDelete);
// chat routes
/**
 * @swagger
 * /chat/user:
 ...
 *                 error: {}
 */
router.get('/chat/history', auth_1.authJWT, ChatController_1.ChatController.getUserChats);
/**
 * @swagger
 * /chat/{roomId}:
 *   get:
 ...
 *                 error: {}
 */
router.get('/chat/room/:roomId', auth_1.authJWT, (0, validation_1.validateRequestParams)(Chat_1.ChatLoadParams), (0, validation_1.validateQueryParams)(Chat_1.ChatLoadQuery), ChatController_1.ChatController.loadChat);
/**
 * @swagger
 * /chat/room/{roomId}:
 *   get:
 ...
 *                 error: {}
 */
router.get('/chat/room/users/:roomId', auth_1.authJWT, (0, validation_1.validateRequestParams)(Chat_1.RoomChatSearchParams), ChatController_1.ChatController.roomChatSearch);
// feeds routes
/**
 * @swagger
 * /feed:
 ...
 *                 error: {}
 */
router.get('/feed', auth_1.authJWT, (0, validation_1.validateQueryParams)(Feed_1.GetFeedsQuery), FeedController_1.FeedController.getFeeds);
/**
 * @swagger
 * /feed:
 *   post:
 ...
 *                 error: {}
 */
router.post('/feed', auth_1.authJWT, uploads.none(), (0, validation_1.validateRequestBody)(Feed_1.FeedCreateSchema), FeedController_1.FeedController.createFeed);
/**
 * @swagger
 * /feed/{id}:
 *   get:
 ...
 *                 error: {}
 */
router.get('/feed/:id', auth_1.authJWT, (0, validation_1.validateRequestParams)(Feed_1.FeedReadParams), FeedController_1.FeedController.readFeed);
/**
 * @swagger
 * /feed/{id}:
 *   patch:
 ...
 *                 error: {}
 */
router.put('/feed/:id', auth_1.authJWT, uploads.none(), (0, validation_1.validateRequestParams)(Feed_1.FeedUpdateParams), (0, validation_1.validateRequestBody)(Feed_1.FeedUpdateSchema), FeedController_1.FeedController.updateFeed);
/**
 * @swagger
 * /feed/{id}:
 *   delete:
 ...
 *                 error: {}
 */
router.delete('/feed/:id', auth_1.authJWT, (0, validation_1.validateRequestParams)(Feed_1.FeedDeleteParams), FeedController_1.FeedController.deleteFeed);
// push notification
/**
 * @swagger
 ...
 *                 error: {}
 */
router.post('/subscribe', uploads.none(), (0, validation_1.validateRequestBody)(Notification_1.PushSubsSchema), NotificationController_1.NotificationController.subscribe);
/**
 * @swagger
 * /notifications/chat:
 *   post:
 ...
 *                 error: {}
 */
router.post('/push/chat', uploads.none(), (0, validation_1.validateRequestBody)(Notification_1.PushChatNotificationSchema), NotificationController_1.NotificationController.pushChat);
/**
 * @swagger
 * /notifications/feed:
 *   post:
 ...
 *                 error: {}
 */
router.post('/push/feed', uploads.none(), (0, validation_1.validateRequestBody)(Notification_1.PushFeedNotificationSchema), NotificationController_1.NotificationController.pushFeed);
